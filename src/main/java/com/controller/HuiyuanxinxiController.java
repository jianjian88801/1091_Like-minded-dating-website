...
public class HuiyuanxinxiController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,HuiyuanxinxiEntity huiyuanxinxi, 
		HttpServletRequest request){
        EntityWrapper<HuiyuanxinxiEntity> ew = new EntityWrapper<HuiyuanxinxiEntity>();
		PageUtils page = huiyuanxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, huiyuanxinxi), params), params));
        return R.ok().put("data", page);
    ...
    public R info(@PathVariable("id") Long id){
		...
		huiyuanxinxi.setClicknum(huiyuanxinxi.getClicknum()+1);
		huiyuanxinxi.setClicktime(new Date());
		huiyuanxinxiService.updateById(huiyuanxinxi);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,HuiyuanxinxiEntity huiyuanxinxi, HttpServletRequest request,String pre){
        EntityWrapper<HuiyuanxinxiEntity> ew = new EntityWrapper<HuiyuanxinxiEntity>();
