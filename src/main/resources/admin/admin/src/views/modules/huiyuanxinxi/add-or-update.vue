<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作" prop="gongzuo">
          <el-input v-model="ruleForm.gongzuo" 
              placeholder="工作" clearable  :readonly="ro.gongzuo"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作" prop="gongzuo">
              <el-input v-model="ruleForm.gongzuo" 
                placeholder="工作" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="爱好" prop="aihao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="爱好"
                  v-model="ruleForm.aihao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.aihao" label="爱好" prop="aihao">
                    <span>{{ruleForm.aihao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.ziwojieshao = this.ruleForm.ziwojieshao.replace(reg,'../../../springboot2x7r5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
