  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="文章分类" prop="wenzhangfenlei">
		  <el-select  @change="wenzhangfenleiChange" clearable v-model="searchForm.wenzhangfenlei" placeholder="请选择文章分类">
		    <el-option
