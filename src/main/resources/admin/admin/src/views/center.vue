  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='huiyuan'"  label="住址" prop="zhuzhi">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='huiyuan'"  label="爱好" prop="aihao">
          <el-input v-model="ruleForm.aihao"               placeholder="爱好" clearable></el-input>
        </el-form-item>
      </el-col>
